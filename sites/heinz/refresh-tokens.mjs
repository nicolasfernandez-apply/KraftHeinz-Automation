/**
 * Refreshes sites/heinz/design-tokens.json from the Figma API.
 *
 * Requires FIGMA_TOKEN env var.  FIGMA_FILE_KEY defaults to the Heinz DS
 ...
 *
 * Usage:
 *   node sites/heinz/refresh-tokens.mjs
 *   FIGMA_TOKEN=figd_... node sites/heinz/refresh-tokens.mjs
 */
...
const FIGMA_FILE_KEY = process.env.FIGMA_FILE_KEY ?? 'o0WsCSDXJaLgf1NVSGFc3c';
...
async function main() {
  ...
  const output = {
    ...
    source:     `Figma file: Heinz — DS (${FIGMA_FILE_KEY})`,
